(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .pp-sc-title { font-size:1.75rem; font-weight:900; color:#fff; line-height:1; margin-bottom:0.85rem; max-width:75%; }
            ...
            <div class="opp-modal-body" style="padding-top:0.6rem;">
              ...
              <div id="ppi-step-1">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.65rem 1rem;margin-bottom:0.65rem;">
                  ...
                  <div class="form-group" style="margin:0;"><label class="form-label">Description <span style="font-weight:400;opacity:0.5;">(optional)</span></label><input class="form-input" id="ppi-description" type="text" placeholder="Any notes for pitchers." /></div>
                </div>
