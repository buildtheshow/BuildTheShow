-- finalize_sponsor_submission's insert into sponsor_files never set production_id,
-- which is a not-null column on that table. Every public sponsor submission that
-- included an uploaded file was failing with:
--   null value in column "production_id" of relation "sponsor_files" violates not-null constraint
-- This has been broken since the very first version of this function; it only
-- surfaced once a real submission actually attached a file.
