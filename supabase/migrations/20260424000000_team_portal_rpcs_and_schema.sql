...
-- ── GRANTS: allow anon (team portal) to call all session RPCs ──
GRANT EXECUTE ON FUNCTION team_member_start_session(uuid,text,text,text) TO anon;
GRANT EXECUTE ON FUNCTION team_member_start_session_for_portal(text,text,text,text,text) TO anon;
GRANT EXECUTE ON FUNCTION team_member_resume_session(uuid,text) TO anon;
GRANT EXECUTE ON FUNCTION team_member_revoke_session(uuid,text) TO anon;
GRANT EXECUTE ON FUNCTION team_member_colour_list_for_session(uuid,text) TO anon;
GRANT EXECUTE ON FUNCTION team_member_update_profile_for_session(uuid,text,text,text,text,text,text,text,text) TO anon;
GRANT EXECUTE ON FUNCTION team_note_add_for_session(uuid,text,uuid,uuid,uuid,text,text,text,integer) TO anon;
GRANT EXECUTE ON FUNCTION team_note_update_for_session(uuid,text,uuid,text) TO anon;
GRANT EXECUTE ON FUNCTION team_note_delete_for_session(uuid,text,uuid) TO anon;
GRANT EXECUTE ON FUNCTION resolve_team_portal(text,text) TO anon;
